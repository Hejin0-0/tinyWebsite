		...
		<section className="py-20 w-full">
			<div className="grid grid-cols-12 gap-4 xs:gap-6 md:gap-8 w-full">
				...
				<ItemLayout className={"col-span-full"}>
					<img
						className="w-full h-auto"
						src={`https://skillicons.dev/icons?i=bootstrap,c,cpp,cloudflare,css,dart,flutter,figma,git,github,html,js,jquery,linux,mysql,nextjs,nodejs,npm,react,replit,python,tailwind,threejs,vercel,vite,vscode,yarn`}
						alt="CodeBucks"
						loading="lazy"
					/>
				</ItemLayout>
				...
				<ItemLayout className={"col-span-full md:col-span-6 !p-0"}>
					<Link
						href="https://github.com/Hejin0-0"
						target="_blank"
						className="w-full"
					>
						<img
